...
export interface ApiTravelPackageTravelPackage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    destination: Attribute.Enumeration<
      ['Pokhara', 'Chitwan', 'Dharan', 'Kalinchowk', 'Mustang', 'Pathivara']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Pokhara'>;
    duration: Attribute.Integer & Attribute.Required;
    departure_date: Attribute.Date & Attribute.Required;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    travel_packages: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::travel-package.travel-package'
    >;
